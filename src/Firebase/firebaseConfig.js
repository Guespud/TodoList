...
import { getFirestore, collection, onSnapshot, updateDoc, doc ,setDoc,arrayUnion,getDoc,arrayRemove} from "firebase/firestore";
...
export { db, collection, onSnapshot, updateDoc, doc,setDoc,arrayUnion,getDoc,arrayRemove };
